    ...
    LazyColumn(
        ...
        item {
            ProfileMenuItemWithDrawable(
                    ...
                    title = "Select Teams", // Changed to "Select Teams" so users know its exact
                    // purpose
        ...
        item {
            ProfileMenuItemWithDrawable(
                    iconRes =
                            R.drawable.ic_league, // Or a different icon for leagues if you have one
                    title = "Select League",
